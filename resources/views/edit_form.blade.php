...
<div class="row">
    ...
    <div class="form-group"> 
        ...
        <input type="text" name="subject" class="form-control" id="InputSubject" value="{{ old('subject') ? old('subject') : $items->subject }}">
    ...
    <div class="form-group">
        ...
        <input type="email" name="email" class="form-control" id="InputEmail" value="{{ old('email') ? old('email') : $items->email }}">
        @if($errors->has('email'))
    ...
    <div class="form-group">
        ...
        {{ old('message') ? old('message') : $items->message }}
        </textarea>
